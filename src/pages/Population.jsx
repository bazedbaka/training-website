    ...
    <main className="container px-4 py-4">
      <div className="row">
        ...
        <article className="col-md-9">
          <h2 className="h2 text-success mb-4">Ареал поширення Фенеків</h2>
          ...
          <section id="countries" className="mt-4">
            ...
            <ul className="list-group mb-3">
                <li className="list-group-item">Алжир</li>
                <li className="list-group-item">Чад</li>
                <li className="list-group-item">Єгипет</li>
                <li className="list-group-item">Лівія</li>
                <li className="list-group-item">Малі</li>
                <li className="list-group-item">Мавританія</li>
                <li className="list-group-item">Марокко</li>
                <li className="list-group-item">Нігер</li>
                <li className="list-group-item">Судан</li>
                <li className="list-group-item">Туніс</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biomes" className="mt-4">
            ...
            <div className="collapse" id="biomesList">
              <ul className="list-group">
                <li className="list-group-item">Пустелі</li>
                <li className="list-group-item">Склерофітні чагарники</li>
              </ul>
            </div>
          </section>
        </article>
